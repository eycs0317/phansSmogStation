...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const testimonialsCreate = await prisma.testimonial.createMany({
      data: testimonials,
    });
    console.log(testimonialsCreate);
    const response = NextResponse.redirect(new URL(siteURL + '/api/generate/testimonials'));
    return response;
  } catch {
